...
import {font_style} from '../styles.js';
...
class CalendarDay extends Component {
  ...
  calcSizes(props) {
    return {
      ...
      dateNameFontSize: Math.round(props.size / 6),
      dateNumberFontSize: Math.round(props.size / 2.9),
      dateMonthFontSize: Math.round(props.size / 6),
    };
  }
          ...
          <View
            ...
            <Text
              style={[
                ...
                {
                  color: Colors.gray_color_opecity,
                  fontSize: 12,
                  textAlign: 'center',
                },
                font_style.font_Book,
              ]}
